...
const universities = graduates.map(function(thing){
  return thing.university.toLowerCase();
});
...
graduates.forEach(function(item){
  return unisWithUni.push(item.university.includes('Uni'));
});
